var eye=document.getElementById("ojo"),input=document.getElementById("password");eye.addEventListener("click",(function(){"password"===input.type?(input.type="text",eye.style.opacity=.8):(input.type="password",eye.style.opacity=.2)}))
